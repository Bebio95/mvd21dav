...
dfcarac = load_data('df_carac.csv')
dfmp = load_data('df_mp.csv')
dfmpmk = load_data('df_mp_marque.csv')
dfmaps = load_data('df_maps.csv')
dfcompl = load_data('df.csv')
dfpvfp = load_data('df_pvfp.csv')
dfcoll= load_data('df_coll.csv')
