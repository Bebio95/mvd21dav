...
#dfcarac = pd.read_csv('df_carac.csv')
#dfmp = pd.read_csv('df_mp.csv')
#dfmpmk = pd.read_csv('df_mp_marque.csv')
#dfmaps = pd.read_csv('df_maps.csv')
#dfcompl = pd.read_csv('df.csv')
#dfpvfp = pd.read_csv('df_pvfp.csv')
#dfcoll= pd.read_csv('df_coll.csv')
dfcarac = pd.read_csv('https://raw.githubusercontent.com/Bebio95/mvd21dav/main/assets/df_carac.csv')
dfmp = pd.read_csv('https://raw.githubusercontent.com/Bebio95/mvd21dav/main/assets/df_mp.csv')
dfmpmk = pd.read_csv('https://raw.githubusercontent.com/Bebio95/mvd21dav/main/assets/df_mp_marque.csv')
dfmaps = pd.read_csv('https://raw.githubusercontent.com/Bebio95/mvd21dav/main/assets/df_maps.csv')
dfcompl = pd.read_csv('https://raw.githubusercontent.com/Bebio95/mvd21dav/main/assets/df.csv')
dfpvfp = pd.read_csv('https://raw.githubusercontent.com/Bebio95/mvd21dav/main/assets/df_pvfp.csv')
dfcoll= pd.read_csv('https://raw.githubusercontent.com/Bebio95/mvd21dav/main/assets/df_coll.csv')
...
# Barre de navigation
                dbc.Col([
                    ...
                    ],className= 'align-items-center',color="primary",inverse=True,style={'height':'67.5vw','border':'none'})
                ], width=2),
                                        ...
                                        dbc.Card([
                                            ...
                                            dbc.CardBody([
                                                    ...
                                                    html.Div(id='tooltip_age',children=[
                                                        ...
                                                        ,style={'margin-left':'0vw','color':'white','fontSize':"2vw",'fontWeight':'bold'}),
                                                        tooltip_age
                                                    ...
                                                    html.Div([
                                                        ...
                                                        ,style={'margin-left':'-1vw','color':'white','fontSize':"2vw",'fontWeight':'bold'}),
                                                        tooltip_activ,
                                                        ],className='card-text d-flex align-items-center justify-content-start',style={'display':'inline-block'}),
                                                    html.P("",style = {'height':'2vw'}),
...
# 3e ligne
                            ...
                            html.Div([
                                dbc.Card([
                                    ...
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.P("",style = {'height':'0.00vw'}),
                                            html.P("Valeur",style={'margin-top':'-0.0vw','fontSize':'1.2vw','color':'rgba(255,255,255,0.9)','height':'1vw'}),
                                            html.Div(id='output_nbvage40',style={'fontWeight': 'bold','fontSize':'1.75vw','margin-top':'-0.5vw','color':'rgba(255,255,255,0.9)'}),
                                            ],className='text-center',style={'margin-left':'10.5vw','margin-top':'0.2vw','display':'block',"border-radius":"100%","border":"1px rgba(255,255,255) solid",
                                            'fontWeight': 'bold','height':'6.25vw','width':'6.25vw'}),

                                                html.Div([
                                                    html.P(id='output_ucage40',style={'margin-left':'3vw','margin-top':'-6vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    html.P("d'UC",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'-5.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    ],className='card-text d-flex justify-content-left',style={'display':'inline-block'}),

                                                html.Div([
                                                    html.P("Durée :",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'1vw','color':'rgba(255,255,255,0.9)'}),
                                                    html.P(id='output_durage40',style={'margin-left':'0.5vw','margin-top':'0.5vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    ],className='card-text d-flex justify-content-left',style={'margin-top':'-3vw','display':'inline-block'}),

                                                html.Div([
                                                    html.I(className="fas fa-chevron-right",style={'margin-top':'-4.5vw','margin-left':'9vw','fontSize':'2vw','color':'rgba(255,255,255,0.9)'}),
                                                    ],className='card-text d-flex justify-content-left',style={}),

                                             ],className='',style={'margin-left':'-0.75vw','background': 'linear-gradient(to left, rgba(219,112,147,0.0), rgba(20,27,34,0.6))','margin-top':'0vw','display':'inline-block'}),

                                        html.P("",style = {'height':'1.0vw'}),

                                        html.Div([
                                            html.Div([
                                                html.I(className="fas fa-money-bill",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_patage40',style={'margin-left':'1.5vw','margin-top':'0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.P("du CA Confirmé",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'0vw','color':'rgba(255,255,255,0.9)'}),
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw'}),

                                            html.Div([
                                                html.I(className="fas fa-gas-pump",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_nbage40',style={'margin-left':'1.5vw','margin-top':'-0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.P("contrats",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'-0vw','color':'rgba(255,255,255,0.9)'}),
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw','margin-top':'-0.25vw'}),

                                            html.Div([
                                                html.I(className="fas fa-credit-card",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_activiteage40',style={'margin-left':'1.5vw','margin-top':'0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.H3("alimenté",style={'margin-top':'-0.5vw','margin-left':'0.5vw','fontSize':'1vw','color':'rgba(255,255,255,0.9)'})
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw','margin-top':'-0.25vw'}),

                                        ],style={'margin-top':'-0.0vw'})
                                    ...
                                    ],color="primary",inverse=True,style={'border':'none','height':'25vw'} #
                                )
                            ])
                        ]),
                                ...
                                dbc.Card([
                                    ...
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.P("",style = {'height':'0.00vw'}),
                                            html.P("Valeur",style={'margin-top':'-0.0vw','fontSize':'1.2vw','color':'rgba(255,255,255,0.9)','height':'1vw'}),
                                            html.Div(id='output_nbvage70',style={'fontWeight': 'bold','fontSize':'1.75vw','margin-top':'-0.5vw','color':'rgba(255,255,255,0.9)'}),
                                            ],className='text-center',style={'margin-left':'10.5vw','margin-top':'0.2vw','display':'block',"border-radius":"100%","border":"1px rgba(255,255,255) solid",
                                            'fontWeight': 'bold','height':'6.25vw','width':'6.25vw'}),

                                                html.Div([
                                                    html.P(id='output_ucage70',style={'margin-left':'3vw','margin-top':'-6vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    html.P("d'UC",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'-5.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    ],className='card-text d-flex justify-content-left',style={'display':'inline-block'}),

                                                html.Div([
                                                    html.P("Durée :",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'1vw','color':'rgba(255,255,255,0.9)'}),
                                                    html.P(id='output_durage70',style={'margin-left':'0.5vw','margin-top':'0.5vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    ],className='card-text d-flex justify-content-left',style={'margin-top':'-3vw','display':'inline-block'}),
                                             ...
                                             ],style={'margin-left':'-0.75vw','background': 'linear-gradient(to left, rgba(219,112,147,0.0), rgba(20,27,34,0.6))','margin-top':'0vw','display':'inline-block'}),
                                        ...
                                        html.Div([
                                            html.Div([
                                                html.I(className="fas fa-money-bill",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_patage70',style={'margin-left':'1.5vw','margin-top':'0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.P("du CA Confirmé",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'0vw','color':'rgba(255,255,255,0.9)'}),
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw'}),

                                            html.Div([
                                                html.I(className="fas fa-gas-pump",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_nbage70',style={'margin-left':'1.5vw','margin-top':'-0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.P("contrats",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'-0vw','color':'rgba(255,255,255,0.9)'}),
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw','margin-top':'-0.25vw'}),

                                            html.Div([
                                                html.I(className="fas fa-credit-card",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_activiteage70',style={'margin-left':'1.5vw','margin-top':'0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.H3("alimenté",style={'margin-top':'-0.5vw','margin-left':'0.5vw','fontSize':'1vw','color':'rgba(255,255,255,0.9)'})
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw','margin-top':'-0.25vw'}),
                                    ...
                                    ],color="rgba(57,62,69,0.9)",inverse=True,style={'border':'none','height':'25vw'} #
                                )
                            ])
                        ]),
                                ...
                                dbc.Card([
                                    ...
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.P("",style = {'height':'0.00vw'}),
                                            html.P("Valeur",style={'margin-top':'-0.0vw','fontSize':'1.2vw','color':'rgba(255,255,255,0.9)','height':'1vw'}),
                                            html.Div(id='output_nbvage75',style={'fontWeight': 'bold','fontSize':'1.75vw','margin-top':'-0.5vw','color':'rgba(255,255,255,0.9)'}),
                                            ],className='text-center',style={'margin-left':'10.5vw','margin-top':'0.2vw','display':'block',"border-radius":"100%","border":"1px rgba(255,255,255) solid",
                                            'fontWeight': 'bold','height':'6.25vw','width':'6.25vw'}),

                                                html.Div([
                                                    html.P(id='output_ucage75',style={'margin-left':'3vw','margin-top':'-6vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    html.P("d'UC",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'-5.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    ],className='card-text d-flex justify-content-left',style={'display':'inline-block'}),

                                                html.Div([
                                                    html.P("Durée :",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'1vw','color':'rgba(255,255,255,0.9)'}),
                                                    html.P(id='output_durage75',style={'margin-left':'0.5vw','margin-top':'0.5vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    ],className='card-text d-flex justify-content-left',style={'margin-top':'-3vw','display':'inline-block'}),
                                        ...
                                        html.Div([
                                            html.Div([
                                                html.I(className="fas fa-money-bill",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_patage75',style={'margin-left':'1.5vw','margin-top':'0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.P("du CA Confirmé",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'0vw','color':'rgba(255,255,255,0.9)'}),
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw'}),

                                            html.Div([
                                                html.I(className="fas fa-gas-pump",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_nbage75',style={'margin-left':'1.5vw','margin-top':'-0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.P("contrats",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'-0vw','color':'rgba(255,255,255,0.9)'}),
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw','margin-top':'-0.25vw'}),

                                            html.Div([
                                                html.I(className="fas fa-credit-card",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_activiteage75',style={'margin-left':'1.5vw','margin-top':'0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.H3("alimenté",style={'margin-top':'-0.5vw','margin-left':'0.5vw','fontSize':'1vw','color':'rgba(255,255,255,0.9)'})
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw','margin-top':'-0.25vw'}),
                                    ...
                                    ],color="rgba(69,68,86,0.9)",inverse=True,style={'border':'none','height':'25vw'} #
                                )
                            ])
                        ]),
                            ...
                            html.Div([
                                dbc.Card([
                                    dbc.CardHeader(
                                       html.Div([
                                            html.I(className="fas fa-user",style={'margin-top':'0.5vw','margin-left':'0.5vw','textAlign':'center','fontSize':'2.5vw','color':'rgba(255,255,255,0.9)','height':'3vw','display':'inline-block'}),
                                            html.H3("Patrimoniaux : 80 ans", className = "card-title mx-auto",style={'margin-top':'0.5vw','textAlign':'center','fontSize':'1.25vw','color':'rgba(255,255,255,0.9)','display':'inline-block'}),
                                    ...
                                    html.Div([
                                        ...
                                        html.Div([
                                            html.P("",style = {'height':'0.00vw'}),
                                            html.P("Valeur",style={'margin-top':'-0.0vw','fontSize':'1.2vw','color':'rgba(255,255,255,0.9)','height':'1vw'}),
                                            html.Div(id='output_nbvage80',style={'fontWeight': 'bold','fontSize':'1.75vw','margin-top':'-0.5vw','color':'rgba(255,255,255,0.9)'}),
                                            ],className='text-center',style={'margin-left':'10.5vw','margin-top':'0.2vw','display':'block',"border-radius":"100%","border":"1px rgba(255,255,255) solid",
                                            'fontWeight': 'bold','height':'6.25vw','width':'6.25vw'}),

                                                html.Div([
                                                    html.P(id='output_ucage80',style={'margin-left':'3vw','margin-top':'-6vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    html.P("d'UC",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'-5.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    ],className='card-text d-flex justify-content-left',style={'display':'inline-block'}),

                                                html.Div([
                                                    html.P("Durée :",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'1vw','color':'rgba(255,255,255,0.9)'}),
                                                    html.P(id='output_durage80',style={'margin-left':'0.5vw','margin-top':'0.5vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                    ],className='card-text d-flex justify-content-left',style={'margin-top':'-3vw','display':'inline-block'}),
                                        ...
                                        html.Div([
                                            html.Div([
                                                html.I(className="fas fa-money-bill",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_patage80',style={'margin-left':'1.5vw','margin-top':'0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.P("du CA Confirmé",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'0vw','color':'rgba(255,255,255,0.9)'}),
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw'}),

                                            html.Div([
                                                html.I(className="fas fa-gas-pump",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_nbage80',style={'margin-left':'1.5vw','margin-top':'-0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.P("contrats",style={'margin-left':'0.5vw','fontSize':'1vw','margin-top':'-0vw','color':'rgba(255,255,255,0.9)'}),
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw','margin-top':'-0.25vw'}),

                                            html.Div([
                                                html.I(className="fas fa-credit-card",style={'margin-top':'-1vw','fontSize':'1.75vw','color':'rgba(255,255,255,0.9)','width':'2vw'}),
                                                html.P(id='output_activiteage80',style={'margin-left':'1.5vw','margin-top':'0vw','fontWeight': 'bold','fontSize':'1.5vw','color':'rgba(255,255,255,0.9)'}),
                                                html.H3("alimenté",style={'margin-top':'-0.5vw','margin-left':'0.5vw','fontSize':'1vw','color':'rgba(255,255,255,0.9)'})
                                                ],className='card-text d-flex justify-content-start align-items-center',style={'margin-left':'1vw','margin-top':'-0.25vw'}),
                                    ...
                                    ],color="rgba(67,93,94,0.9)",inverse=True,style={'border':'none','height':'25vw'} #
                                )
                            ])
                        ]),
    ...
    ]),className='d-flex align-items-center',color = 'rgba(7, 27, 47, 0.95)')
])
...
def update_pie(mark_selected):
    ...
    card1 = int(np.round(dfmp_filtered["CA"].sum()/10**6,0))
    card2 = dfmp_filtered["%UC_marque"].max()
    card3 = dfmp_filtered["Age_marque"].max()
    card4 = dfmp_filtered["Prime_marque"].max()
    card5 = dfcarac_filtered["Activ"].max()
    card6 = dfcarac_filtered["Turnover"].max()
    ...
    nbv_gp=np.where((mark_selected=="MMA Courtage")|(mark_selected=="MMA CAP"),"","GP :{}%".format(valeur_GP))
    nbv_pp=np.where((mark_selected=="MMA Courtage")|(mark_selected=="MMA CAP"),"","PP :{}%".format(valeur_PP))
    ...
    fig=px.pie(dfmp_filtered[(dfmp_filtered['Pat']!="NC")&(dfmp_filtered['Pat']!="Ex Confirme")], values="%CA", names="Pat", hole=0.6,color_discrete_sequence=color4,opacity=1
                    ).update_layout(
...
def update_nbvage(mark_selected):
    ...
    nbvage40=np.round((df["NBV"].sum())*100,1)
    ...
    nbvage70=np.round((df["NBV"].sum())*100,1)
    ...
    nbvage75=np.round((df["NBV"].sum())*100,1)
    ...
    nbvage80=np.round((df["NBV"].sum())*100,1)
